...
type
{$IFDEF CPUX64}
	ssize_t = Int64;  //64-bit signed
	size_t  = UInt64; //64-bit unsigned
{$ELSE}
	ssize_t = Integer;  //32-bit signed
	size_t  = Cardinal; //32-bit unsigned
{$ENDIF}
...
// Throws an exception if ACode indicates an error
function ZSTDCheck(const AFunctionName: string; ACode: size_t): size_t;

// Throws an exception based on the code
procedure ZSTDError(const AFunctionName: string; ACode: size_t);


// Return runtime library version, the value is (MAJOR*100*100 + MINOR*100 + RELEASE)
function ZSTD_versionNumber: DWORD;     {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_versionNumber;{$ENDIF}
...
***************************************)
	...
	ZSTD_MAGICNUMBER           = $FD2FB528;    // Compressed dictionary.   Valid since v0.8.0
	ZSTD_MAGIC_DICTIONARY      = $EC30A437;    // Uncompressed dictionary. Valid since v0.7.0
...
function ZSTD_compress(dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_compress;{$ENDIF}
...
function ZSTD_isError(code: size_t): DWORD;           {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_isError;{$ENDIF}       (*!< tells if a `size_t` function result is an error code *)
...
function ZSTD_minCLevel: Integer;                     {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_minCLevel;{$ENDIF}
function ZSTD_maxCLevel: Integer;                     {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_maxCLevel;{$ENDIF}
...
function ZSTD_compressCCtx(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_compressCCtx;{$ENDIF}
 ...
 *)
function ZSTD_CCtx_setParameter(cctx: ZSTD_CCtx; param: ZSTD_cParameter; value: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_CCtx_setParameter;{$ENDIF}
 ...
 *)
function ZSTD_DCtx_setParameter(dctx: ZSTD_DCtx; param: ZSTD_dParameter; value: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_DCtx_setParameter;{$ENDIF}
 ...
 *)
function ZSTD_initCStream(zcs: ZSTD_CStream; compressionLevel: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_initCStream;{$ENDIF}
(**
...
function ZSTD_compress_usingDict(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; dict: Pointer; dictSize: size_t; compressionLevel: Integer): size_t; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_compress_usingDict;{$ENDIF}
...
function ZSTD_createCDict(dictBuffer: Pointer; dictSize: size_t; compressionLevel: Integer): ZSTD_CDict; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_createCDict;{$ENDIF}
...
function ZSTD_getDictID_fromDict(dict: Pointer; dictSize: size_t): DWORD; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_getDictID_fromDict;{$ENDIF}

(*! ZSTD_getDictID_fromDDict() :
 *  Provides the dictID of the dictionary loaded into `ddict`.
 *  If @return == 0, the dictionary is not conformant to Zstandard specification, or empty.
 *  Non-conformant dictionaries can still be loaded, but as content-only dictionaries. *)
function ZSTD_getDictID_fromDDict(ddict: ZSTD_DDict): DWORD; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_getDictID_fromDDict;{$ENDIF}
...
function ZSTD_getDictID_fromFrame(src: Pointer; srcSize: size_t): DWORD; {$IFDEF ZSTD_STATIC_LINKING}cdecl; external ZSTDDllName name sZSTD_getDictID_fromFrame;{$ENDIF}
...
function ZSTD_getErrorCode(ACode: size_t): ZSTD_ErrorCode;
begin
...
begin
{
	Raises an exception if the specified ACode indicates an error.
	Otherwise returns the supplied ACode.
}
	Result := ACode;
	if ZSTD_isError(ACode) = 0 then
		Exit;

	case ZSTD_getErrorCode(ACode) of
	ZSTD_error_frameParameter_windowTooLarge,
	ZSTD_error_memory_allocation:
		raise EOutOfMemory.Create(GetExceptionMessage(AFunctionName, ACode));
	else
...
type
	TZSTD_versionNumber				= function: DWORD; cdecl;
	TZSTD_versionString				= function: PAnsiChar; cdecl;
	TZSTD_compress						= function(dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t; cdecl;
	...
	TZSTD_isError						= function(code: size_t): DWORD; cdecl;
	TZSTD_getErrorName				= function(code: size_t): PAnsiChar; cdecl;
	TZSTD_minCLevel					= function: Integer; cdecl;
	TZSTD_maxCLevel					= function: Integer; cdecl;
	TZSTD_createCCtx					= function: ZSTD_CCtx; cdecl;
	TZSTD_freeCCtx						= function(cctx: ZSTD_CCtx): size_t; cdecl;
	TZSTD_compressCCtx				= function(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t; cdecl;
	...
	TZSTD_CCtx_setParameter			= function(cctx: ZSTD_CCtx; param: ZSTD_cParameter; value: Integer): size_t; cdecl;
	...
	TZSTD_DCtx_setParameter			= function(dctx: ZSTD_DCtx; param: ZSTD_dParameter; value: Integer): size_t; cdecl;
	...
	TZSTD_initCStream					= function(zcs: ZSTD_CStream; compressionLevel: Integer): size_t; cdecl;
	...
	TZSTD_compress_usingDict		= function(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; dict: Pointer; dictSize: size_t; compressionLevel: Integer): size_t; cdecl;
	...
	TZSTD_createCDict					= function(dictBuffer: Pointer; dictSize: size_t; compressionLevel: Integer): ZSTD_CDict; cdecl;
	...
	TZSTD_getDictID_fromDict		= function(dict: Pointer; dictSize: size_t): DWORD; cdecl;
	TZSTD_getDictID_fromDDict		= function(ddict: ZSTD_DDict): DWORD; cdecl;
	TZSTD_getDictID_fromFrame		= function(src: Pointer; srcSize: size_t): DWORD; cdecl;
...
begin
	...
	try
		if ZSTD <> 0 then Exit;
		ZSTD := LoadLibrary(PChar(ZSTDDllName));
		if ZSTD = 0 then Exit;
...
begin
	if ErrorCode <> 0 then
		e := EOSError.CreateResFmt(@SOSError, [ErrorCode, SysErrorMessage(ErrorCode)])
	else
		e := EOSError.CreateRes(@SUnkOSError);
...
function ZSTD_versionNumber: DWORD;
begin
	InitZSTD;
...
function ZSTD_compress(dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t;
begin
	InitZSTD;

	if not Assigned(@_ZSTD_compress) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
begin
	InitZSTD;
	if not Assigned(@_ZSTD_decompress) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
begin
	...
	if not Assigned(@_ZSTD_getFrameContentSize) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
begin
	...
	if not Assigned(@_ZSTD_getDecompressedSize) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
begin
	...
	if not Assigned(@_ZSTD_findFrameCompressedSize) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
function ZSTD_isError(code: size_t): DWORD;
begin
{
	Most ZSTD_* functions returning a size_t value can be tested for error using
	...
	InitZSTD;
	if not Assigned(@_ZSTD_isError) then
	begin
...
begin
	InitZSTD;
	if not Assigned(@_ZSTD_getErrorName) then
	begin
		Result := nil;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
function ZSTD_minCLevel: Integer;
begin
	InitZSTD;
...
function ZSTD_maxCLevel: Integer;
begin
	InitZSTD;
...
function ZSTD_compressCCtx(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; compressionLevel: Integer): size_t;
begin
	InitZSTD;
...
function ZSTD_CCtx_setParameter(cctx: ZSTD_CCtx; param: ZSTD_cParameter; value: Integer): size_t;
begin
	InitZSTD;
...
function ZSTD_DCtx_setParameter(dctx: ZSTD_DCtx; param: ZSTD_dParameter; value: Integer): size_t;
begin
	InitZSTD;
...
begin
	InitZSTD;
	if not Assigned(@_ZSTD_compressStream2) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
function ZSTD_initCStream(zcs: ZSTD_CStream; compressionLevel: Integer): size_t;
begin
	InitZSTD;
...
begin
	InitZSTD;
	if not Assigned(@_ZSTD_decompressStream) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
begin
	InitZSTD;
	if not Assigned(@_ZSTD_DStreamInSize) then
	begin
		Result := 0;
		RaiseLastOSError(ERROR_PROC_NOT_FOUND);
		Exit;
...
function ZSTD_compress_usingDict(ctx: ZSTD_CCtx; dst: Pointer; dstCapacity: size_t; src: Pointer; srcSize: size_t; dict: Pointer; dictSize: size_t; compressionLevel: Integer): size_t;
begin
	InitZSTD;
...
function ZSTD_createCDict(dictBuffer: Pointer; dictSize: size_t; compressionLevel: Integer): ZSTD_CDict;
begin
	InitZSTD;
...
function ZSTD_getDictID_fromDict(dict: Pointer; dictSize: size_t): DWORD;
begin
	InitZSTD;
...
function ZSTD_getDictID_fromDDict(ddict: ZSTD_DDict): DWORD;
begin
	InitZSTD;
...
function ZSTD_getDictID_fromFrame(src: Pointer; srcSize: size_t): DWORD;
begin
	InitZSTD;
